#!/usr/bin/env python
"""Launch a PF07 assay-structured DAG sweep on the main Presto affinity path."""
...
DEFAULT_PREFIX = "presto-pf07-dag-20260316a"
DEFAULT_EPOCHS = 50
...
VARIANTS = (
    ...
    },
    {
        ...
        "design_id": "presto_pf07_dag_family",
    ...
    },
    {
        ...
        "design_id": "presto_pf07_dag_method_leaf",
    ...
    },
    {
        ...
        "design_id": "presto_pf07_dag_prep_readout_leaf",
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Launch PF07 assay-structured DAG sweep on the main Presto affinity path."
    )
    ...
    out_dir = initialize_experiment_dir(
        ...
        slug="pf07-assay-structured-dag-sweep",
        title="PF07 Assay-Structured DAG Sweep",
        source_script="experiments/2026-03-16_2355_codex_pf07-assay-structured-dag-sweep/code/launch.py",
