#!/usr/bin/env python
"""Launch a matched local CPU vs MPS focused PF07 mini-train comparison."""
...
DEFAULT_PREFIX = "presto-focused-device-minitrain-20260319a"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run matched local CPU vs MPS focused PF07 mini-train comparison.")
