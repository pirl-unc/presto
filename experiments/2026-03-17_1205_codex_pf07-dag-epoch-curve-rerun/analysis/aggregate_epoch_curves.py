#!/usr/bin/env python
"""Aggregate per-epoch metric curves for the PF07 DAG epoch-curve rerun."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Aggregate per-epoch metric curves for a PF07 DAG rerun.")
