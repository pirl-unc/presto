#!/usr/bin/env python
"""Launch a PF07-only optimization extension on the main Presto codepath."""
...
DEFAULT_PREFIX = "presto-pf07-opt-20260316a"
DEFAULT_EPOCHS = 50
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Launch PF07 optimization extension on the main Presto codepath.")
    ...
    out_dir = initialize_experiment_dir(
        ...
        slug="pf07-mainpath-optimization-extension",
        title="PF07 Main-Path Optimization Extension",
        source_script="experiments/2026-03-16_1441_codex_pf07-mainpath-optimization-extension/code/launch.py",
