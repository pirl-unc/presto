...
APP_NAME = "presto-source-junction-masking"
CHECKPOINT_VOLUME_NAME = "presto-checkpoints"
DATA_VOLUME_NAME = "presto-data"
PREFIX = "presto-source-junction-mask-20260902b"
...
def preflight_condition() -> dict[str, Any]:
    ...
    if observed_mhc_index_hash != MHC_INDEX_SHA256:
        raise RuntimeError(
            "Preflight MHC index hash mismatch: " f"{observed_mhc_index_hash}"
        )
...
def main(preflight_only: bool = False) -> None:
    ...
    initialize_experiment_dir(
        ...
        slug="source-junction-masking",
        title="Source-junction ambiguity masking",
