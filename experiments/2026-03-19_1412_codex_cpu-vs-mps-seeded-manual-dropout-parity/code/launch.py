#!/usr/bin/env python
"""Launch a matched local CPU vs MPS focused PF07 manual-dropout parity run."""
...
DEFAULT_PREFIX = "presto-focused-device-seededmanual-20260319a"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run matched local CPU vs MPS focused PF07 manual-dropout parity comparison.")
    ...
    out_dir = initialize_experiment_dir(
        ...
        title="CPU vs MPS Focused PF07 Seeded Manual-Dropout Parity Compare",
