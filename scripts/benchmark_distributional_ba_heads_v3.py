#!/usr/bin/env python
"""Launch 24-condition v3 MHCflurry MAX × embed_dim sweep on Modal.

Usage:
    python scripts/benchmark_distributional_ba_heads_v3.py
    python scripts/benchmark_distributional_ba_heads_v3.py --cond-ids 1,7,13
    python scripts/benchmark_distributional_ba_heads_v3.py --dry-run
"""
...
from presto.scripts.distributional_ba.config_v3 import CONDITIONS_V3, ConditionSpec
...
def _launch_condition(
    *,
    ...
    cmd = [
        ...
        "run",
        "--detach",
        "scripts/train_modal.py::distributional_ba_v3_run",
        "--cond-id",
        str(spec.cond_id),
        "--epochs",
        str(epochs),
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Launch 24-condition v3 MHCflurry MAX × embed_dim sweep on Modal",
    )
    ...
    parser.add_argument("--prefix", type=str, default="dist-ba-v3")
    ...
    parser.add_argument(
        ...
        type=str,
        default="",
        help="Optional comma-separated subset of condition IDs (1-24).",
    )
    ...
    selected_conditions = [
        spec for spec in CONDITIONS_V3 if not selected_ids or spec.cond_id in selected_ids
    ]
    ...
    out_dir = initialize_experiment_dir(
        ...
        slug="mhcflurry-max-dim-sweep",
        title="MHCflurry MAX × Encoder Dimension Sweep (24 conditions)",
        source_script="scripts/benchmark_distributional_ba_heads_v3.py",
        ...
        metadata={
            ...
            "sweep_axes": {
                "max_nM": [25000, 50000, 75000, 100000, 125000, 150000],
